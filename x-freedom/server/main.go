//Package main generated by 'freedom new-project x-freedom'
package main
...
import (
	...
	"gorm.io/gorm"
	"time"
	_ "x-freedom/adapter/controller" //Implicit initialization controller
	_ "x-freedom/adapter/repository" //Implicit initialization repository
	"x-freedom/server/conf"
)
